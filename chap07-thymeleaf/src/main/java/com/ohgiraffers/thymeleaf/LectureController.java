...
public class LectureController {
    ...
    public ModelAndView conditional(ModelAndView mv) {
        ...
        List<MemberDTO> memeberList = new ArrayList<>();
        memeberList.add(new MemberDTO("홍길동",20,'남',"서울시 종로구"));
        memeberList.add(new MemberDTO("유관순",16,'여',"서울시 노원구"));
        memeberList.add(new MemberDTO("장보고",30,'남',"서울시 성북구"));
        memeberList.add(new MemberDTO("신사임당",40,'여',"서울시 서초구"));
        mv.addObject("memberList", memeberList);
