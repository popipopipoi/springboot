...
public class JsonDataController {
    ...
    public JsonDataController() {
        ...
        userList.add(new UserDTO("1", "유관순", 16, "yoo123@ohgiraffers.con", new Date()));
        userList.add(new UserDTO("2", "홍길동", 20, "hong123@ohgiraffers.con", new Date()));
        userList.add(new UserDTO("3", "신사임당", 30, "shin123@ohgiraffers.con", new Date()));
    }
    ...
    * Spring boot web에는 Jackson-dataind 라이브러리가 기본 포함 되어 JSON => Java Object parsing이 자동으로 처리 된다.
    * 1. String
